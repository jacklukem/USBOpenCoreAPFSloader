...
sudo osascript -e 'display notification "USB preparing please wait a couple of minutes" with title "USBOpenCoreAPFSloader3bs" subtitle "Do not remove the USB drive during this phase"'
echo "\nInstalling the bootloader to its boot path"
sudo unzip -qo -P jackluke /private/tmp/USBOpenCoreAPFSloader3bs/OpenCore -d /Volumes/EFIext
sudo bless --folder /Volumes/EFIext/EFI/Boot --label "OpenCoreAPFSloader3bs"
sudo osascript -e 'display notification "USBOpenCoreAPFSloader3bs is ready" with title "USBOpenCoreAPFSloader3bs"'
echo "\nDone"
